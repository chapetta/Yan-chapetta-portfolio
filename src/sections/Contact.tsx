    ...
    >
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-12">
        ...
        <motion.div
          ...
          className="rounded-[2.5rem] border border-surface-light-muted/70 bg-white/80 p-10 text-center backdrop-blur-xl transition-colors dark:border-white/10 dark:bg-slate-900/70"
        >
          <motion.div
            variants={scaleIn}
            className="mx-auto grid max-w-4xl grid-cols-12 gap-6 text-left text-slate-600 transition-colors dark:text-slate-300"
          >
            <div className="col-span-12 flex flex-col items-center gap-4 text-center lg:col-span-4 lg:items-start lg:text-left">
              <div className="inline-flex items-center gap-3 rounded-full border border-white/40 bg-white/80 px-5 py-2 text-sm uppercase tracking-[0.4em] text-slate-500 transition-colors dark:border-white/10 dark:bg-white/5 dark:text-slate-300">
                <MessageCircle size={18} className="text-accent" />
                resposta rápida
              </div>
              <h3 className="font-display text-[clamp(2rem,4vw,2.6rem)] font-semibold text-slate-900 transition-colors dark:text-white">
            ...
            <div className="col-span-12 grid gap-4 text-sm lg:col-span-8 lg:grid-cols-2">
              <a
                ...
                className="flex items-center gap-3 rounded-2xl border border-surface-light-muted/70 bg-white/80 px-4 py-3 transition-colors duration-300 hover:border-primary/60 hover:bg-primary/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary dark:border-white/10 dark:bg-white/5"
              >
                <span className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 dark:bg-white/10">
              ...
              <div className="flex items-center gap-3 rounded-2xl border border-surface-light-muted/70 bg-white/80 px-4 py-3 transition-colors duration-300 dark:border-white/10 dark:bg-white/5">
                <span className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 dark:bg-white/10">
