...
export const softSkills: SoftSkill[] = [
  {
    ...
    description: 'Uso Scrum e Kanban para organizar backlog, cadenciar sprints e medir evolução.'
  },
  {
    title: 'Comunicação Empática',
    description: 'Colaboração clara com designers, product managers e stakeholders.'
  },
  {
    title: 'Ownership',
    description: 'Faço follow-up constante, documento decisões e puxo melhorias contínuas.'
  },
  {
    title: 'Aprendizado Contínuo',
    description: 'Rotina diária de estudo com foco em automações, testes e performance.'
  }
]
...
export const projects: Project[] = [
  {
    ...
    technologies: ['React', 'TypeScript', 'TailwindCSS', 'Context API', 'Zod', 'React Hook Form'],
  ...
  },
  {
    ...
    technologies: ['React', 'TypeScript', 'Zustand', 'TailwindCSS', 'Zod', 'Shadcn/UI'],
  ...
  },
  {
    ...
    technologies: ['React', 'TypeScript', 'TailwindCSS', 'React Router', 'API Integration'],
    repoUrl: 'https://github.com/chapetta/code-beats',
    imageUrl: 'https://raw.githubusercontent.com/chapetta/code-beats/main/demo.gif',
  ...
  },
  {
    ...
    technologies: ['Node.js', 'Express', 'PostgreSQL', 'Prisma', 'Swagger', 'TypeScript'],
...
export const skills: Skill[] = [
  ...
  },
  {
    name: 'Framer Motion',
    category: 'Frontend',
    iconUrl: 'https://raw.githubusercontent.com/simple-icons/simple-icons/develop/icons/framermotion.svg',
    level: 'Intermediário'
  },
  {
    name: 'Node.js',
  ...
  },
  {
    name: 'GitHub Actions',
    category: 'DevOps',
    iconUrl: 'https://raw.githubusercontent.com/simple-icons/simple-icons/develop/icons/githubactions.svg',
    level: 'Intermediário'
  },
  {
    name: 'Git',
...
export const whatsappLink =
  'https://wa.me/5599999999999?text=Ol%C3%A1%20Yan%2C%20vi%20seu%20portf%C3%B3lio%20e%20gostaria%20de%20conversar!'
...
export const resumeUrl = '/yan-chapetta-cv.pdf'
